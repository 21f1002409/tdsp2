...
def country_outline_api_endpoint():
    ...
    return "https://ga4-3.vercel.app/api/outline"
...
"""
    ...
    try:
        ...
        if e.status == 404:
            ...
            raise
    return "https://github.com/21f1002409/ga4_8"
...
if __name__ == "__main__":
    ...
    print("=================Q8====================")
    print(create_github_action_workflow("21f1002409@ds.iitm.ac.in"))
