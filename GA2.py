...
def update_index_html(email):
    ...
    # Hard-coded settings
    repo_name = "21f1002409/gitpages"  # Replace with your GitHub username and repository name
    branch = "main"
    ...
    return "https://21f1002409.github.io/gitpages/"
...
def deploy_to_vercel(json_filepath):
    ...
    github_repo = "21f1002409/ga2_9"
    json_file = "q-vercel-python.json"
    github_branch = "main"
    access_token = os.getenv("ACCESS_TOKEN")
    vercel_token = os.getenv("VERCEL_TOKEN")
    fixed_vercel_url = "https://vercel1-kappa-livid.vercel.app/api"
...
def update_and_trigger_workflow(email):
    ...
    owner, repo, path, branch = "21f1002409", "github_actions_demo", ".github/workflows/github-actions-demo.yml", "main"
    token = os.getenv("ACCESS_TOKEN")
    ...
    if requests.post(trigger_url, json={"ref": branch}, headers=headers).status_code == 204:
        return "https://github.com/21f1002409/github_actions_demo"
    else:
...
def build_and_push_image(tag):
    ...
    repo_name = "21f1002409/ga2_8" #replace with your repo name
    ...
    try:
        ...
        for step in yaml_content["jobs"]["build-and-push"]["steps"]:
            if step.get("uses") == "docker/build-push-action@v3":
                step["with"]["tags"] = f"21f1002409/ga2_8:{tag}"
        ...
        time.sleep(20)
        return "https://hub.docker.com/repository/docker/21f1002409/ga2_8/general"
...
def deploy_fastapi(csv_filepath):
    ...
    access_token = os.getenv("ACCESS_TOKEN")
    vercel_token = os.getenv("VERCEL_TOKEN")
    fixed_vercel_url = "https://ga2-9-fastapi.vercel.app/api"
...
if __name__ == "__main__":
    ...
    print("=================Q3====================")
    email = "21f1002409@ds.study.iitm.ac.in"
